      ...
      <div className="bg-gradient-to-r from-slate-900 to-slate-800 py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold text-white mb-3">
            Documentos <span className="text-emerald-400">CREG</span>
          </h1>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {categorias.map((cat) => (
              ...
              >
                ...
                <div
                  className={`bg-gradient-to-r ${TIPO_HEADER[cat.tipo] || "from-slate-600 to-slate-700"} px-5 py-4`}
                >
        ...
        {!loading && !error && (
          <div className="mt-8 p-4 bg-blue-50 border border-blue-200 rounded-xl flex items-start gap-3">
            ...
            <p className="text-blue-700 text-sm">
              ...
              y se actualiza automáticamente cada hora. Para ver el documento
              completo, haz clic en el título.
            </p>
          </div>
        )}
      </div>
